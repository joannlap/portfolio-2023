  ...
  state: () => ({
    work: [
      ...
      },
      {
        ...
        date: "2024",
        tags: ["Event graphics", "Print"],
        description:
          "This collective was rooted in the street styles of Hip-Hop by bringing dance and urban sports to the theatre. For various events within ISH Community, part of ISH Dance Collective, I developed promotional materials. The outputs ranged from posters and flyers to business cards and online banners.",
        images: [
          "/images/work/ish/ScenesOfSolstice-main2.jpg",
          "/images/work/ish/avantgarde-ish-battle.jpg",
      ...
      {
        id: 1,
        title: "TNO Messenger campaign teaser",
